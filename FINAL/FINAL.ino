...
void setup() {
    ...
    wifiMulti.addAP("GERALD 0380", "face12345");
...
void sendData(){
  ...
  http.begin("http://172.16.6.35/waterlevel/waterTB.php?ownerID=1&location=Eastlegon&water_level=" + String(distanceCm));
  int httpCode = http.GET();
...
void sendinformation() {
  ...
  http.begin("http://172.16.6.35/waterlevel/ownerTB.php?ownerID=1&first_name=Eben&last_name=Akolly");
  int httpCode = http.GET();
  String result = http.getString();
//  Serial.println(result);
}
